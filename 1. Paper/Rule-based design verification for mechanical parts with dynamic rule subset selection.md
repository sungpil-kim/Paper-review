...
검증 방정식 분리 : 검증 방정식을 단위 방정식으로 분리<br>
3 x π ≤〖𝐷1〗_𝑐𝑢𝑝, 〖𝐷1〗_𝑐𝑢𝑝 ≤ 10 x 〖sin⁡(𝐻1〗_𝑐𝑢𝑝)<br>
매개변수 값 대입 : 설계 변수를 사용자 매개변수 값으로 대체<br>
3 x π ≤ 10.5, 10.5 ≤ 10 x sin(30)<br>
수학 상수 대입 : 수학 상수가 포함된 경우, 실제 값으로 대체<br>
3 x 3.141592.. ≤ 10.5, 10.5 ≤ 10 x sin(30)<br>
수학 방정식 계산 : 수학적 표현을 값으로 대체<br>
3 x 3.141592.. ≤ 10.5, 10.5 ≤ 10 x 0.5<Br>
결과 반환 : True / False 결과가 반환<br>
false

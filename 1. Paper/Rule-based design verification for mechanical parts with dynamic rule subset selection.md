...
- 논문 주제의 필요성<br>
  제품 개발 프로세스에 있어 초기에 설계 문제점을 검증하는 것은 매우 중요하다. 특히 3D CAD 모델은 커뮤니케이션 및 부품 호환성 검증을 통해 제품 안정성을 확보하는데 핵심적인 역할을 하고있다. 따라서 설계검증을 통해 생산비용 절감 및 제품 품질 향상시킬 수 있다.<br>
   ⇒ 실제 자동차 생산 프로세스 전 과정을 경험하면서 초기의 설계 컨셉이 매우 중요하다는 것을 느꼈다. 자동차 생산 프로세스의 경우 연구소에서 이루어지는 T-CAR부터 P1, 공장에서 이루어지는 P2부터 양산까지의 단계에서 실제 초기 컨셉이 유지되는 경우가 많다. 이는 신차더라도 선행차가 존재하기 떄문에 양산으로 신뢰성이 있는 선행차를 유사하게 따라가는 경우가 많으며 따라서 초기 단계에 설정한 위치, 경로 등이 양산까지 이어질 수 있다. 물론 해석 / 시험 기준 미달에 따른 컨셉이 아예 달라지는 경우도 존재한다.  
